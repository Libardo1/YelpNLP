...
***Describe where your data set comes from and what variables make it up.***
...
&nbsp;&nbsp;&nbsp;&nbsp;In a secondary cleaning, the 203 categorical variables were evaluated for how much preference each had for one side of the response. This was quantified using the formula
\[
\frac{\max{\left( p_{high} , p_{low} \right)}}{\min{\left( p_{high} , p_{low} \right)}},
\]
where
\[
p_{high} = \mathrm{\frac{number \thinspace of \thinspace ``high" \thinspace reviews \thinspace with \thinspace cue}{total \thinspace numbers \thinspace of \thinspace ``high" \thinspace reviews}} \enskip \mathrm{and} \enskip p_{low} = \mathrm{\frac{number \thinspace of \thinspace ``low" \thinspace reviews \thinspace with \thinspace cue}{total \thinspace number \thinspace of \thinspace ``low" \thinspace reviews}}.
\]
After dropping all categorical variables with less than two units of sorting power as defined above, the final data set included a sample of 93423 reviews and 102 predictor variables. 
